...
/** the root url of the application with trailing slash, for example http://localhost/economic-analyzer/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'economic-analyzer/';
