...
/**
 * TbActionMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the TbActionDAO to the tb_action datastore.
 *
 ...
 * @version 1.0
 */
class TbActionMap implements IDaoMap, IDaoMap2
{
