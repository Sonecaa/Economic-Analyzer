...
/**
 * TbFilesMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the TbFilesDAO to the tb_files datastore.
 *
 ...
 * @version 1.0
 */
class TbFilesMap implements IDaoMap, IDaoMap2
{
