...
/**
 * TbPaymentsMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the TbPaymentsDAO to the tb_payments datastore.
 *
 ...
 * @version 1.0
 */
class TbPaymentsMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetKeyMaps()
	{
		if (self::$KM == null)
		{
			...
			self::$KM["fk_tb_payments_tb_beneficiaries1"] = new KeyMap("fk_tb_payments_tb_beneficiaries1", "TbBeneficiariesIdBeneficiaries", "TbBeneficiaries", "IdBeneficiaries", KM_TYPE_MANYTOONE, KM_LOAD_LAZY); // you change to KM_LOAD_EAGER here or (preferrably) make the change in _config.php
