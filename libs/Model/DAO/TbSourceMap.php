...
/**
 * TbSourceMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the TbSourceDAO to the tb_source datastore.
 *
 ...
 * @version 1.0
 */
class TbSourceMap implements IDaoMap, IDaoMap2
{
