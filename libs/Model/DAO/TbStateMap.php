...
/**
 * TbStateMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the TbStateDAO to the tb_state datastore.
 *
 ...
 * @version 1.0
 */
class TbStateMap implements IDaoMap, IDaoMap2
{
