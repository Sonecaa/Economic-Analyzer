...
require_once("DAO/TbActionCriteriaDAO.php");

/**
 * The TbActionCriteria class extends TbActionDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbActionCriteria extends TbActionCriteriaDAO
{
