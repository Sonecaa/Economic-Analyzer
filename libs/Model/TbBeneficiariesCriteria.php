...
require_once("DAO/TbBeneficiariesCriteriaDAO.php");

/**
 * The TbBeneficiariesCriteria class extends TbBeneficiariesDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbBeneficiariesCriteria extends TbBeneficiariesCriteriaDAO
{
