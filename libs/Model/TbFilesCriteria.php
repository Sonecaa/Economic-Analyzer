...
require_once("DAO/TbFilesCriteriaDAO.php");

/**
 * The TbFilesCriteria class extends TbFilesDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbFilesCriteria extends TbFilesCriteriaDAO
{
