...
require_once("DAO/TbFunctionsCriteriaDAO.php");

/**
 * The TbFunctionsCriteria class extends TbFunctionsDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbFunctionsCriteria extends TbFunctionsCriteriaDAO
{
