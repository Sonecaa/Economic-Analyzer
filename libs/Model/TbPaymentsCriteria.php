...
require_once("DAO/TbPaymentsCriteriaDAO.php");

/**
 * The TbPaymentsCriteria class extends TbPaymentsDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbPaymentsCriteria extends TbPaymentsCriteriaDAO
{
