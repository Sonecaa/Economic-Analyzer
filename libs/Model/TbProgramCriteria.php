...
require_once("DAO/TbProgramCriteriaDAO.php");

/**
 * The TbProgramCriteria class extends TbProgramDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbProgramCriteria extends TbProgramCriteriaDAO
{
