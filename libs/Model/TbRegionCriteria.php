...
require_once("DAO/TbRegionCriteriaDAO.php");

/**
 * The TbRegionCriteria class extends TbRegionDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbRegionCriteria extends TbRegionCriteriaDAO
{
