...
require_once("DAO/TbSourceCriteriaDAO.php");

/**
 * The TbSourceCriteria class extends TbSourceDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbSourceCriteria extends TbSourceCriteriaDAO
{
