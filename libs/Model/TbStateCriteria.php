...
require_once("DAO/TbStateCriteriaDAO.php");

/**
 * The TbStateCriteria class extends TbStateDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbStateCriteria extends TbStateCriteriaDAO
{
