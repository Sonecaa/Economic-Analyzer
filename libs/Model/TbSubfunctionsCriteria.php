...
require_once("DAO/TbSubfunctionsCriteriaDAO.php");

/**
 * The TbSubfunctionsCriteria class extends TbSubfunctionsDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbSubfunctionsCriteria extends TbSubfunctionsCriteriaDAO
{
