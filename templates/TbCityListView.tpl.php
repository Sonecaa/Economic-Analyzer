<?php
	$this->assign('title','economic-analyzer | TbCities');
	$this->assign('nav','tbcities');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/tbcities.js").wait(function(){
...
<h1>
	<i class="icon-th-list"></i> TbCities
	...
	<script type="text/template" id="tbCityCollectionTemplate">
	...
	<script type="text/template" id="tbCityModelTemplate">
		...
		<form id="deleteTbCityButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deleteTbCityButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete TbCity</button>
						<span id="confirmDeleteTbCityContainer" class="hide">
							<button id="cancelDeleteTbCityButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteTbCityButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade" id="tbCityDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit TbCity
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="tbCityModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="saveTbCityButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="tbCityCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newTbCityButton" class="btn btn-primary">Add TbCity</button>
	</p>
