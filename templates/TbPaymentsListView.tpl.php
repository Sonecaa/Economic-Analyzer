<?php
	$this->assign('title','economic-analyzer | TbPaymentses');
	$this->assign('nav','tbpaymentses');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/tbpaymentses.js").wait(function(){
...
<h1>
	<i class="icon-th-list"></i> TbPaymentses
	...
	<script type="text/template" id="tbPaymentsCollectionTemplate">
...
-->
	...
	<script type="text/template" id="tbPaymentsModelTemplate">
		...
		<form id="deleteTbPaymentsButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deleteTbPaymentsButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete TbPayments</button>
						<span id="confirmDeleteTbPaymentsContainer" class="hide">
							<button id="cancelDeleteTbPaymentsButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteTbPaymentsButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade" id="tbPaymentsDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit TbPayments
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="tbPaymentsModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="saveTbPaymentsButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="tbPaymentsCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newTbPaymentsButton" class="btn btn-primary">Add TbPayments</button>
	</p>
