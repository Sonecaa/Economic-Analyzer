<?php
	$this->assign('title','economic-analyzer | TbStates');
	$this->assign('nav','tbstates');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/tbstates.js").wait(function(){
...
<h1>
	<i class="icon-th-list"></i> TbStates
	...
	<script type="text/template" id="tbStateCollectionTemplate">
	...
	<script type="text/template" id="tbStateModelTemplate">
		...
		<form id="deleteTbStateButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deleteTbStateButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete TbState</button>
						<span id="confirmDeleteTbStateContainer" class="hide">
							<button id="cancelDeleteTbStateButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteTbStateButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade" id="tbStateDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit TbState
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="tbStateModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="saveTbStateButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="tbStateCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newTbStateButton" class="btn btn-primary">Add TbState</button>
	</p>
